<?php foreach ($panelData as $r) { ?>
    <div class="col-xs-4 col-sm-3 col-lg-2 embed-responsive embed-responsive-4by3">
        <div class="panel" style="background-color:<?= $r['backcolor'] ?>; border-color:<?= $r['bordercolor'] ?>;">
