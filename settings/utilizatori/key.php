...
<?php if($err!='NO') { ?><div role="alert" class="alert alert-danger"><strong class="glyphicon glyphicon-warning-sign"></strong> <?php echo $err ?></div><?php } ?>
...
function generate()
{
	...
	document.getElementById("passgen").innerHTML='<div role="alert" class="alert alert-info">Parola generata: <tt><strong>'+pa+'</strong></tt></div>';
}
</script>
