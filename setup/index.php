...
?>        
                    ...
                    <a href="#" class="btn btn-primary my-2 float-right" onclick="$('#card1').slideUp();$('#card2').slideDown()">Next &raquo;</a>
                </div>                
    ...
    ?>        
                    ...
                    <input name="s[APP_DB_SERVER]" type="text" class="form-control" id="dbName" value="localhost" />
                    <hr />
                    <label for="dbName">Database name</label>
                    <input name="s[APP_DB_NAME]" type="text" class="form-control" id="dbName" placeholder="Ex. iadmin_db" value="" />
                    <hr />
                    <label for="dbUser">Database user</label>
                    <input name="s[APP_DB_USER]" type="text" class="form-control" id="dbUser" placeholder="Ex. root" value="" />
                    <hr />
                    <label for="dbPass">Database password</label>
                    <input name="s[APP_DB_PASS]" type="text" class="form-control" id="dbPass" placeholder="" value="" />

                    <a href="#" class="btn btn-primary my-2 float-left" onclick="$('#card1').slideDown();$('#card2').slideUp()">&laquo; Prev</a>
                    <a href="#" class="btn btn-primary my-2 float-right" onclick="$('#card2').slideUp();$('#card3').slideDown()">Next &raquo;</a>
                ...
                <div class="card-body" id="card3"> 
                    ...
                    <input name="iPass" type="text" class="form-control" id="iPass" placeholder="" value="" />

                    <a href="#" class="btn btn-primary my-2 float-left" onclick="$('#card2').slideDown();$('#card3').slideUp()">&laquo; Prev</a>
